                                ...
                                for (int i = 0; i < calendar_time.Count; i++)
                                {
                                    ...
                                    using (var path = it.rect_read.RoundPath(Radius))
                                    {
                                        if (SelDate.HasValue)
                                        {
                                            ...
                                            {
                                                case 0:
                                                    if (it.t == SelDate.Value.Hour) g.FillPath(brush_bg, path);
                                                    break;
                                                case 1:
                                                    if (it.t == SelDate.Value.Minute) g.FillPath(brush_bg, path);
                                                    break;
                                                case 2:
                                                    if (it.t == SelDate.Value.Second) g.FillPath(brush_bg, path);
                                                    break;
                                            }
                                        }
                                        if (it.hover)
