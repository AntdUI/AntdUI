                                    ...
                                    switch (it.rx)
                                    {
                                        case 1:
                                            if (it.Contains(x, y + ScrollM.Value))
                                            {
                                                ...
                                                else SelDate = new DateTime(DateNow.Year, DateNow.Month, DateNow.Day, 0, it.t, 0);
                                                Print();
                                        ...
                                        case 2:
                                            if (it.Contains(x, y + ScrollS.Value))
                                            {
                                                ...
                                                else SelDate = new DateTime(DateNow.Year, DateNow.Month, DateNow.Day, 0, 0, it.t);
                                                Print();
                                                if (ValueTimeHorizontal) ScrollTime(calendar_time, SelDate.Value);
                                                return;
                                            }
                                        ...
                                        default:
                                            if (it.Contains(x, y + ScrollH.Value))
                                            {
                                                ...
                                                else SelDate = new DateTime(DateNow.Year, DateNow.Month, DateNow.Day, it.t, 0, 0);
                                                Print();
                                                if (ValueTimeHorizontal) ScrollTime(calendar_time, SelDate.Value);
                                                return;
                                            }
