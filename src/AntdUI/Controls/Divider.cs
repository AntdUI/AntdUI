                        ...
                        switch (Orientation)
                        {
                            case TOrientation.Left:
                                if (f_margin > 0)
                                {
                                    ...
                                    g.String(text_, Font, enabled ? ForeColor : Colour.TextQuaternary.Get("Divider", ColorScheme), font_irect, s_f);
                                }
                                else
                                {
                            ...
                            default:
                                ...
                                g.String(text_, Font, enabled ? ForeColor : Colour.TextQuaternary.Get("Divider", ColorScheme), _rect, s_f);
                                break;
                        }
                    }
                    else
                        ...
                        switch (Orientation)
                        {
                            case TOrientation.Left:
                                if (f_margin > 0)
                                {
                                    ...
                                    g.String(Text, Font, enabled ? ForeColor : Colour.TextQuaternary.Get("Divider", ColorScheme), font_irect, s_f_all);
                                }
                                else
                                {
                            ...
                            default:
                                ...
                                g.String(Text, Font, enabled ? ForeColor : Colour.TextQuaternary.Get("Divider", ColorScheme), _rect, s_f_all);
                                break;
                        }
                    }
                }
