...
![1](InstallOldVersionFramework/1.png)
...
![2](InstallOldVersionFramework/2.png)

下载得到安装包`.nupkg`

![3](InstallOldVersionFramework/3.png)

然后后缀名字修改为`.zip`解压后得到里面的内容

![4](InstallOldVersionFramework/4.png)

解压后，进入`build/.NETFramework`文件夹，找到v4.5文件夹

![5](InstallOldVersionFramework/5.png)

将`v4.5`文件夹 复制到 **`C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework`** 直接覆盖替换文件夹和文件

![6](InstallOldVersionFramework/6.png)
