...
The demo has table AOT examples, and the AOT generated exe can also be downloaded on the publishing page. It supports MVVM, but AOT does not support reflection. [example/Demo/Controls/TableAOT.cs](https://gitee.com/AntdUI/AntdUI/blob/main/example/Demo/Controls/TableAOT.cs#L348)