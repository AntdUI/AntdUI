...
| Example | [![Breadcrumb](Icon/Breadcrumb.png)](Control/Breadcrumb.md) |
| [Dropdown](Control/Dropdown.md) | A dropdown list. |
| Example | [![Dropdown](Icon/Dropdown.png)](Control/Dropdown.md) |
| [Menu](Control/Menu.md) | A versatile menu for navigation. |
| Example | [![Menu](Icon/Menu.png)](Control/Menu.md) |
| [PageHeader](Control/PageHeader.md) | A page header serves as a content overview and guides page level operations. |
| Example | [![PageHeader](Icon/PageHeader.png)](Control/PageHeader.md) |
| [TabHeader](Control/TabHeader.md) | Multi tab page switching header |
| Example | [![TabHeader](Icon/TabHeader.png)](Control/TabHeader.md) |
...
| Example | [![Battery](Icon/Battery.png)](Control/Battery.md) |
| [Signal](Control/Signal.md) | Display device signals. |
| Example | [![Signal](Icon/Signal.png)](Control/Signal.md) |
| [Shield](Control/Shield.md) | Concise, consistent, and legible badges. |
| Example | [![Shield](Icon/Shield.png)](Control/Shield.md) |
| [ContextMenuStrip](Control/ContextMenuStrip.md) | Right click on the current page at will |
| Example | [![ContextMenuStrip](Icon/ContextMenuStrip.png)](Control/ContextMenuStrip.md) |
| [Image3D](Control/Image3D.md) | used to display 3D effect images |
| Example | [![Image3D](Icon/Image3D.gif)](Control/Image3D.md) |
