...
> **Apache License 2.0 说明**：Apache许可证是一种宽松的开源软件许可证，由Apache软件基金会发布。它允许人们自由使用、修改和分发软件，只需保留原作者的版权声明和许可证文本。与MIT许可证相比，Apache许可证更详细地规定了专利授权和贡献者责任。
...
1. **STTextBox** - Input 控件灵感来源
2. **Vanara** - Win32 部分实现
3. **ChineseCalendar** - 日历中的农历功能

#### 采用其他协议的项目

- **SVG.NET** - 采用 MS-PL License（微软公共许可证）