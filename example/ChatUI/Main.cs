...
namespace ChatUI
{
    public partial class Main : AntdUI.Window
    {
        ...
        {
            InitializeComponent();
            msgList.ItemSelected += MsgList_ItemSelected;
            msgList.ItemRightClick += MsgList_ItemRightClick;
            chatList.ItemClick += ChatList_ItemClick;
        ...
        private void MsgList_ItemRightClick(object sender, AntdUI.MsgItemEventArgs e)
        {
        ...
        private AntdUI.IContextMenuStripItem[] menulist = { };

        private void ChatList_ItemClick(object sender, AntdUI.ChatItemEventArgs e)
        {
           
        }

        private void MsgList_ItemSelected(object sender, AntdUI.MsgItemEventArgs e)
        {
        }
