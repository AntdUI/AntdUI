...
namespace Demo.Controls
{
    public partial class ContextMenuStrip : UserControl
    {
        ...
        Form form;
        public ContextMenuStrip(Form form)
        {
            InitializeComponent();
            this.form = form;
        }
        ...
        IContextMenuStripItem[] menulist = {};
        ...
        private void RightKey()
        {
            ...
            AntdUI.ContextMenuStrip.open(this, it =>
            {
                ...
                AntdUI.Message.info(this.ParentForm, "点击内容：" + it.Text);
        ...
        private void RightKey(ContextMenuStripItem it)
        {
