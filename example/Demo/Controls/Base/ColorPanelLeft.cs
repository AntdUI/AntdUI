...
namespace AntdUI
{
    ...
    public class ColorPanelLeft : IControl
    {
        ...
        readonly static FormatFlags s_f = FormatFlags.Left | FormatFlags.VerticalCenter | FormatFlags.NoWrapEllipsis;
            ...
            using (var brush = new SolidBrush(ForeColor))
            {
                ...
                else
                {
                    ...
                    using (var font = new Font(Font.FontFamily, Font.Size * 0.7F))
                    {
                        ...
                        {
                            g.String(desc, font, brush_desc, new Rectangle(rect.X, rect.Y + y + (int)(size.Height * 1.2F), rect.Width, sizedesc.Height), s_f);
                        }
                    }
                }
            }
